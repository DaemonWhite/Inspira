#define MyAppName "Inspira"
#define MyAppVersion "0.1.0"
#define MyAppPublisher "kramo"
#define MyAppURL "https://github.com/DaemonWhite/Inspira/"
#define MyAppExeName "pythonw.exe"

[Setup]
AppId={{c02e1bdb-d47c-4f6e-bd8a-420acc567c34}}
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppVerName={#MyAppName} {#MyAppVersion}
AppPublisher={#MyAppPublisher}
AppPublisherURL={#MyAppURL}
AppSupportURL=https://github.com/DaemonWhite/Inspira/issues
AppUpdatesURL={#MyAppURL}
DefaultDirName={autopf64}\{#MyAppName}
DisableProgramGroupPage=yes
LicenseFile=..\..\..\COPYING
PrivilegesRequiredOverridesAllowed=dialog
OutputBaseFilename=Inspira Windows
...
[Files]
Source: "D:\a\_temp\msys64\ucrt64\bin\inspira"; DestDir: "{app}\bin"; Flags: ignoreversion
...
Source: "D:\a\_temp\msys64\ucrt64\share\inspira\*"; DestDir: "{app}\share\inspira"; Excludes: "__pycache__"; Flags: recursesubdirs ignoreversion
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\bin\{#MyAppExeName}"; Parameters: """{app}\bin\inspira"""; IconFilename: "{app}\icon.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\bin\{#MyAppExeName}"; Parameters: """{app}\bin\inspira"""; IconFilename: "{app}\icon.ico"; Tasks: desktopicon

[Run]
Filename: "{app}\bin\{#MyAppExeName}"; Parameters: """{app}\bin\inspira"""; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall